...
<head>
    ...
    <title>M-TECH-235 | MANTRATECH AND SERVICES PVT. LTD.</title>
...
<body class="_active-preloader-ovh">
    ...
    <div class="page-wrapper">
        ...
        <div class="inner-banner">
            <div class="container">
                <h3>Model- 1000Lph M-Tech-235</h3>
                <ul class="breadcumb">
                    <li><a href="/">Home</a></li>
