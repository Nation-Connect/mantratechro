...
<head>
    ...
    <title>M-TECH-420 | MANTRATECH AND SERVICES PVT. LTD.</title>
...
<body class="_active-preloader-ovh">
    ...
    <div class="page-wrapper">
        ...
        <div class="inner-banner">
            <div class="container">
                <h3>Model- 1000Lph M-Tech-420</h3>
                <ul class="breadcumb">
                    <li><a href="/">Home</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <div class="project-details-content">
                            <br />
                            <h3>Model- 1000Lph M-Tech-420</h3>
                            <img src="img/products/mtech-420.jpg" alt="Mantratech" width="100%" />
                            <br />
                            <br />
                            <p class="text-justify">We manufacture and supply superior quality range of SS Mineral Ro Plants for optimum use of scarce fresh water resources. Our range includes Mineral Water Plant, Packaged drinking water plant, Reverse Osmosis Water Plant, Water Softener Plant, Demineraliser Plant, Sewage Treatment Plant. SS Mineral Ro Plant Manufacturer in Patna Bihar Mantratech Ro System. These treatment plants are manufactured using quality tested spares that ensure durability and low treatment cost.</p>
                            <br />
